...
const Preview: React.FC<PreviewProps> = ({ data, innerRef }) => {
  return (
    ...
    >
      ...
      <div className="mt-8 border-t border-white/5 pt-8 flex flex-col items-center space-y-2 md:space-y-3 z-10">
        <div className="text-[8px] md:text-[10px] font-black text-gray-500 tracking-[0.4em] uppercase">Authenticated By</div>
        <div className="font-signature text-3xl md:text-5xl text-white drop-shadow-[0_0_15px_rgba(34,197,94,0.4)]">{data.signatureText}</div>
        
        <div className="pt-4 flex flex-wrap justify-center gap-4 md:gap-10 text-[9px] md:text-[12px] font-bold tracking-widest text-gray-500 uppercase">
