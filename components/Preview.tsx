  ...
  return (
    <div 
      ...
      style={{
        ...
        // Massive bottom padding to ensure text safety on all screens
        padding: 'clamp(20px, 4vw, 40px) clamp(25px, 5vw, 50px) clamp(80px, 14vw, 130px) clamp(25px, 5vw, 50px)',
        color: 'white'
      }}
    >
      ...
      {/* Header Section */}
      <div className="flex justify-between items-start mb-5 md:mb-8 z-10">
        <div className="flex items-center gap-3 md:gap-4">
            <GDGBrackets size={55} />
            <div className="flex flex-col leading-tight">
                <span className="text-[11px] md:text-[17px] font-black text-white tracking-tight leading-none">
                  {data.organizationName || 'Google Developer Groups'}
                </span>
                <span className="text-[8px] md:text-[9px] font-bold text-gray-500 uppercase tracking-[0.2em] mt-1">
        ...
        <div className="text-right leading-none uppercase shrink-0">
          <div className="text-[6px] md:text-[8px] font-black tracking-[0.3em] text-gray-500 mb-1">RECOGNITION</div>
          <div className="text-lg md:text-2xl font-black italic text-white leading-none">STUDENT</div>
          <div className="text-[7px] md:text-[10px] font-bold bg-green-500 text-white inline-block px-3 py-1 mt-1 rounded-sm tracking-widest whitespace-nowrap">OF THE MONTH</div>
        </div>
      </div>

      {/* Main Content Grid */}
      <div className="grid grid-cols-12 gap-5 md:gap-7 items-start flex-grow z-10">
        ...
        <div className="col-span-6 flex flex-col space-y-4 md:space-y-6">
           <div className="space-y-4 md:space-y-6">
             ...
             <div className="relative bg-white/5 rounded-[1.5rem] md:rounded-[2.5rem] p-1 border border-white/10 overflow-hidden shadow-2xl aspect-square">
               ...
               <div className="absolute bottom-3 right-3 bg-green-500 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center border-4 border-[#020617] shadow-lg">
             ...
             {/* Name Banner */}
             <div className="bg-white py-3 md:py-4 px-3 md:px-4 rounded-xl md:rounded-[2rem] text-center shadow-xl border-b-[5px] border-slate-200">
               <h3 className="text-[10px] md:text-[16px] font-black uppercase tracking-wide leading-tight text-black line-clamp-2">
           ...
           {/* Motivation Section */}
           <div className="bg-white/5 p-4 md:p-5 rounded-[1.5rem] md:rounded-[2rem] border border-white/5 shadow-inner">
             <div className="text-green-400 text-[6px] md:text-[7px] font-black uppercase tracking-[0.2em] border-l-[3px] border-green-500 pl-2.5 mb-2.5">
                {data.motivationTitle}
             </div>
             <p className="text-[8px] md:text-[12px] font-medium leading-relaxed italic opacity-90 text-gray-200 line-clamp-4">
        ...
        <div className="col-span-6 flex flex-col space-y-2 md:space-y-3 h-full">
          ...
          <div className="mt-auto pt-4 flex flex-col items-center">
             <div className="w-full flex items-center gap-3 mb-1">
                ...
                <div className="text-[5px] md:text-[7px] font-black text-gray-500 tracking-[0.3em] uppercase">Authenticated By</div>
                <div className="h-px bg-white/10 flex-grow"></div>
             </div>
             <div className="font-signature text-xl md:text-3xl text-white drop-shadow-[0_0_12px_rgba(34,197,94,0.5)] py-1.5">
                {data.signatureText}
             </div>
          </div>
        </div>
      ...
      {/* Footer / Social Connectivity - Increased safety margin */}
      <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center z-10">
...
const AttributeRow: React.FC<{ label: string; value: string }> = ({ label, value }) => (
  <div className="flex items-stretch min-h-[32px] md:min-h-[48px] bg-white/5 rounded-lg md:rounded-2xl overflow-hidden border border-white/5 group shadow-lg">
    <div className="bg-green-600 text-white flex items-center justify-center text-[6px] md:text-[8px] font-black w-[40px] md:w-[75px] px-1 text-center uppercase leading-none shrink-0 tracking-widest">
      {label}
    </div>
    <div className="flex-grow flex items-center px-3 md:px-5 py-1">
      <span className="text-gray-100 text-[8px] md:text-[12px] font-bold leading-tight line-clamp-2 italic">
        {value || '---'}
      </span>
    </div>
  </div>
